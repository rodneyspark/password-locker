...
class TestUser(unittest.TestCase):
    ...
    def setUp(self):
        ...
        '''
        self.new_user = User("rodney", "0875345") # create contact object
    ...
    def test_init(self):
        ...
        self.assertEqual(self.new_user.username,"rodney")
    ...
    def test_find_user_by_username(self):
        ...
        '''
        self.new_user.save_user()
        test_user = User("rodney", "0875345")
        test_user.save_user()
        found_user = User.find_user_by_username("rodney")
